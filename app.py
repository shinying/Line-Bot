...
def handle_message(event):
    ...
    if re.match('[哈呵嘿嘻]', text) or re.match('XD+', text):
        message = TextSendMessage(text="0x100079")
    if re.match('.*常見問題', text):
        ...
        message = TextSendMessage(text="Line不但是台灣市佔率最高的通訊軟體，也是積極開拓新服務和跨國網路和軟體公司，我很想試試和國際級的人才並肩工作的感覺！0x1000A5")
        ...
        if re.match('.*歌手', text):
            ...
            message = TextSendMessage(text="其他喜歡的東西還沒有加入喔～0x100065")
